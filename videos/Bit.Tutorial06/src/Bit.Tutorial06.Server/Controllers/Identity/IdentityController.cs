using System.Web;
using Bit.Tutorial06.Client.Core.Controllers.Identity;
using Bit.Tutorial06.Server.Components;
using Bit.Tutorial06.Server.Models.Emailing;
using Bit.Tutorial06.Server.Models.Identity;
using Bit.Tutorial06.Server.Resources;
...
namespace Bit.Tutorial06.Server.Controllers.Identity;
