...
using Bit.Tutorial09.Server;
using Bit.Tutorial09.Server.Models.Identity;
using Bit.Tutorial09.Server.Services;
...
public static class IServiceCollectionExtensions
{
    ...
    public static void AddSwaggerGen(this IServiceCollection services)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "Bit.Tutorial09.Server.xml"));
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "Bit.Tutorial09.Shared.xml"));
