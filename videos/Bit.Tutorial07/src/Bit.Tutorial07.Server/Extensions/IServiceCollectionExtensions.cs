...
using Bit.Tutorial07.Server;
using Bit.Tutorial07.Server.Models.Identity;
using Bit.Tutorial07.Server.Services;
...
public static class IServiceCollectionExtensions
{
    ...
    public static void AddSwaggerGen(this IServiceCollection services)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "Bit.Tutorial07.Server.xml"));
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "Bit.Tutorial07.Shared.xml"));
