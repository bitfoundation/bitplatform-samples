// <auto-generated />
using Bit.Tutorial07.Server.Data;
...
namespace Bit.Tutorial07.Server.Data.Migrations
{
    ...
    [Migration("20240112204547_AddProductAndCategory")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bit.Tutorial07.Server.Models.Identity.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Bit.Tutorial07.Server.Models.Identity.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Bit.Tutorial07.Server.Models.Sample.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Bit.Tutorial07.Server.Models.Sample.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Bit.Tutorial07.Server.Models.Sample.Product", b =>
                {
                    b.HasOne("Bit.Tutorial07.Server.Models.Sample.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Bit.Tutorial07.Server.Models.Identity.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Bit.Tutorial07.Server.Models.Identity.User", null)
                        .WithMany()
