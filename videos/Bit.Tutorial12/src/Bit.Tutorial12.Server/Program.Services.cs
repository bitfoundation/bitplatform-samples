...
using Bit.Tutorial12.Server.Services;
using Bit.Tutorial12.Client.Web;
using Microsoft.AspNetCore.HttpOverrides;
using Microsoft.AspNetCore.ResponseCompression;
using System.Net.Mail;
using System.Net;
using System.Security.Cryptography.X509Certificates;
using Bit.Tutorial12.Server.Models.Identity;
...
namespace Bit.Tutorial12.Server;
...
public static partial class Program
{
    ...
    private static void AddSwaggerGen(WebApplicationBuilder builder)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "Bit.Tutorial12.Server.xml"));
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "Bit.Tutorial12.Shared.xml"));
