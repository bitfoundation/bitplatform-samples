using System.Web;
using Bit.Tutorial12.Client.Core.Controllers.Identity;
using Bit.Tutorial12.Server.Components;
using Bit.Tutorial12.Server.Models.Emailing;
using Bit.Tutorial12.Server.Models.Identity;
using Bit.Tutorial12.Server.Resources;
using Bit.Tutorial12.Shared.Dtos.Identity;
using FluentEmail.Core;
using Microsoft.AspNetCore.Authentication.BearerToken;
using Microsoft.AspNetCore.Components;
using Microsoft.AspNetCore.Components.Web;

namespace Bit.Tutorial12.Server.Controllers.Identity;
