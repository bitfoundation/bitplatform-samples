...
using Bit.Tutorial10.Server.Services;
using Bit.Tutorial10.Client.Web;
...
namespace Bit.Tutorial10.Server;
...
public static partial class Program
{
    ...
    private static void AddSwaggerGen(WebApplicationBuilder builder)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "Bit.Tutorial10.Server.xml"));
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "Bit.Tutorial10.Shared.xml"));
