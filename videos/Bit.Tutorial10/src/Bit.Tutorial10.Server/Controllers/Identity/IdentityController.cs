...
using Bit.Tutorial10.Server.Components;
using Bit.Tutorial10.Server.Models.Emailing;
using Bit.Tutorial10.Server.Models.Identity;
using Bit.Tutorial10.Server.Resources;
...
namespace Bit.Tutorial10.Server.Controllers.Identity;
