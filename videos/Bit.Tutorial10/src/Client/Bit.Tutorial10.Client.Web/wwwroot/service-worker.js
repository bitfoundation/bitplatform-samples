// bit version: 8.7.5-pre-03-pre-01
...
self.assetsExclude = [
    ...
    /Client\.Web\.styles\.css$/ // In .NET 8, an inexistent CSS file is inadvertently included in the assets list under the name 'Bit.Tutorial10.Client.Web.styles.css.'
