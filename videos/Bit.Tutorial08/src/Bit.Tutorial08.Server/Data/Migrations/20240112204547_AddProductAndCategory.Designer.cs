// <auto-generated />
using Bit.Tutorial08.Server.Data;
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bit.Tutorial08.Server.Models.Identity.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Bit.Tutorial08.Server.Models.Identity.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Bit.Tutorial08.Server.Models.Sample.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Bit.Tutorial08.Server.Models.Sample.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Bit.Tutorial08.Server.Models.Sample.Product", b =>
                {
                    b.HasOne("Bit.Tutorial08.Server.Models.Sample.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Bit.Tutorial08.Server.Models.Identity.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Bit.Tutorial08.Server.Models.Identity.User", null)
                        .WithMany()
