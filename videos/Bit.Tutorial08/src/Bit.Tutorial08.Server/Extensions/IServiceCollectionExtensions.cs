...
using Bit.Tutorial08.Server;
using Bit.Tutorial08.Server.Models.Identity;
using Bit.Tutorial08.Server.Services;
...
public static class IServiceCollectionExtensions
{
    ...
    public static void AddSwaggerGen(this IServiceCollection services)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "Bit.Tutorial08.Server.xml"));
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "Bit.Tutorial08.Shared.xml"));
