...
using System.Web;
using Bit.Tutorial11.Client.Core.Services;
...
namespace Bit.Tutorial11.Server;
...
public static partial class Program
{
    ...
    public static void ConfiureMiddlewares(this WebApplication app)
    {
        ...
        var blazorApp = app.MapRazorComponents<Bit.Tutorial11.Server.Components.App>()
            .AddInteractiveServerRenderMode()
            .AddInteractiveWebAssemblyRenderMode()
            .AddAdditionalAssemblies(AssemblyLoadContext.Default.Assemblies.Where(asm => asm.GetName().Name?.Contains("Bit.Tutorial11") is true).Except([Assembly.GetExecutingAssembly()]).ToArray());
