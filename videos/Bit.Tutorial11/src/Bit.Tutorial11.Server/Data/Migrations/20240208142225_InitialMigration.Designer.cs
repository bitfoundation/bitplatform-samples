// <auto-generated />
using Bit.Tutorial11.Server.Data;
...
namespace Bit.Tutorial11.Server.Data.Migrations
{
    ...
    [Migration("20240208142225_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bit.Tutorial11.Server.Models.Categories.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Bit.Tutorial11.Server.Models.Identity.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Bit.Tutorial11.Server.Models.Identity.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Bit.Tutorial11.Server.Models.Products.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedOn = 1307485863936000060L,
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            CreatedOn = 1307477016576000060L,
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 1,
                            CreatedOn = 1307459321856000060L,
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 1,
                            CreatedOn = 1307450474496000060L,
                        ...
                        new
                        {
                            Id = 5,
                            CategoryId = 1,
                            CreatedOn = 1307441627136000060L,
                        ...
                        new
                        {
                            Id = 15,
                            CategoryId = 4,
                            CreatedOn = 1307468169216000060L,
                            Description = "",
                            Name = "530e",
                            Price = 56545m
                        },
                        ...
                        new
                        {
                            Id = 19,
                            CategoryId = 4,
                            CreatedOn = 1307432779776000060L,
                            Description = "",
                            Name = "IX",
                            Price = 87000m
                        },
            ...
            modelBuilder.Entity("Bit.Tutorial11.Server.Models.Products.Product", b =>
                {
                    b.HasOne("Bit.Tutorial11.Server.Models.Categories.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Bit.Tutorial11.Server.Models.Identity.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Bit.Tutorial11.Server.Models.Identity.User", null)
                        .WithMany()
